...
from algorithms.Constrained_searching.AC_3 import ac3
from algorithms.Constrained_searching.Backtracking import backtracking
from algorithms.Constrained_searching.Testing import backtracking_with_ac3
...
algorithms = {
    ...
    "Backtracking with AC3": backtracking_with_ac3,
    "AC-3 only": ac3,
}
